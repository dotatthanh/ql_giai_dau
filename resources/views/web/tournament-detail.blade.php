...
@section('content')
    <div class="container">
        <h2 class="title">CHI TIẾT GIẢI ĐẤU</h2>
        <div class="row">
            <div class="col-12 text-center">
                <img src="{{ asset($tournament->image) }}" alt="" class="w-1001">
            </div>
                ...
                <div class="col-12" style="padding : 20px;">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h2 class="text-center h3">Các trận đấu</h2>
                                ...
                                <div class="row justify-content-center mt-3">
                                    ...
                                    <div class="col-1 text-center">
                                        ...
                                        @else
                                            -
                                        @endif
                                        <a href="{{ route('web.match-detail', $match->id) }}" class="d-block">Chi tiết</a>
                                    </div>
        ...
        <div class="row1">
            ...
            <div class="col-12" style="font-size : 40px;"> {!! $tournament->description !!} </div>
        </div>
    </div>
@endsection
