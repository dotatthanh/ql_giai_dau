...
@section('title') Cập nhật giải đấu @endsection
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật giải đấu</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Cập nhật giải đấu</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <form method="POST" action="{{ route('tournaments.update', $data_edit->id) }}" enctype="multipart/form-data">
                                    @method('PUT')
                                    @include('tournament._form', ['routeType' => 'update'])
