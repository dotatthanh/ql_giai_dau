...
@section('title') Thêm giải đấu @endsection
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm giải đấu</h4>
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Thêm giải đấu</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <form method="POST" action="{{ route('tournaments.store') }}" enctype="multipart/form-data">
                                    ...
                                    @include('tournament._form', ['routeType' => 'create'])
