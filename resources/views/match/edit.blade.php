            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Cập nhật trận đấu</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('matchs.index') }}"
                                            title="Quản lý trận đấu" data-toggle="tooltip" data-placement="top">Quản lý trận
                                            đấu</a></li>
                                    <li class="breadcrumb-item active">Cập nhật trận đấu</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST" action="{{ route('matchs.update', $data_edit->id) }}"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @include('match._form', ['routeType' => 'update'])
