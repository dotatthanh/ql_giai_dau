                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Thêm trận đấu</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="{{ route('universities.index') }}" title="Quản lý trận đấu" data-toggle="tooltip" data-placement="top">Quản lý trận đấu</a></li>
                                    <li class="breadcrumb-item active">Thêm trận đấu</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <form method="POST" action="{{ route('matchs.store') }}" enctype="multipart/form-data">
                                    ...
                                    @include('match._form', ['routeType' => 'create'])
